defmodule LiveviewDemoWeb.Router do
  ...
  import LiveviewDemoWeb.UserAuth
  ...
  scope "/", LiveviewDemoWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LiveviewDemoWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", LiveviewDemoWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{LiveviewDemoWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", LiveviewDemoWeb do
    ...
    live_session :current_user,
      on_mount: [{LiveviewDemoWeb.UserAuth, :mount_current_user}] do
